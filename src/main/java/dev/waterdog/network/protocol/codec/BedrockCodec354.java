...
public class BedrockCodec354 extends BedrockCodec340 {

    @Override
    public ProtocolVersion getProtocol() {
        return ProtocolVersion.MINECRAFT_PE_1_11;
    }

    @Override
    public void buildCodec(BedrockPacketCodec.Builder builder) {
        super.buildCodec(builder);
        builder.helper(BedrockPacketHelper_v354.INSTANCE);

        builder.deregisterPacket(UpdateTradePacket.class);
