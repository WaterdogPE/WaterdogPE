...
public class PackManager {
    ...
    private ResourcePack constructPack(Path packPath) {
        ...
        try {
            ...
            this.proxy.getLogger().error("Resource pack manifest.json is invalid or was not found in " + packPath.getFileName() + ", please make sure that you zip the content of the pack and not the folder!");
        } catch (Exception e) {
