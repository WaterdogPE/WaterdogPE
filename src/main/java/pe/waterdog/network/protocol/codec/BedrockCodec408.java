...
public class BedrockCodec408 extends BedrockCodec {
    ...
    public void buildCodec(BedrockPacketCodec.Builder builder) {
        builder.helper(BedrockPacketHelper_v407.INSTANCE)
                ...
                .registerPacket(SetDifficultyPacket.class, SetDifficultySerializer_v291.INSTANCE, 60) //TODO:
                ...
                .registerPacket(EmotePacket.class, EmoteSerializer_v388.INSTANCE, 138) //TODO: rewrite
